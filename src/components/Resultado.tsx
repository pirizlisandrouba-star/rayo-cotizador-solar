...
import { ResultadoCotizacion, ResultadoPaquete } from '@/lib/calculadora';
  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="text-center mb-8">
        ...
        <h2 className="text-2xl sm:text-3xl font-bold text-rayo-azul-oscuro">
      ...
      <div className="bg-white rounded-2xl p-5 shadow-sm mb-6 max-w-md mx-auto">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="text-center">
            <p className="text-2xl font-bold text-rayo-azul-oscuro">
          ...
          <button
            ...
            className={`px-4 py-2 rounded-lg text-sm font-medium transition-all ${
              tipoInstalacion === 'on_grid'
                ? 'bg-rayo-azul-oscuro text-rayo-amarillo shadow'
      ...
      {/* Triple Impacto */}
      <div className="bg-rayo-azul-oscuro rounded-2xl p-6 text-white mb-8">
        ...
        <div className="grid grid-cols-3 gap-4 text-center">
          <div>
            ...
            <p className="text-xs mt-1 text-gray-300">Económico</p>
            <p className="text-sm font-medium mt-1">Ahorro real en tu factura</p>
          </div>
          <div>
            <span className="text-2xl">🌍</span>
            <p className="text-xs mt-1 text-gray-300">Ambiental</p>
            <p className="text-sm font-medium mt-1">Energía limpia, menos CO₂</p>
          </div>
          <div>
            <span className="text-2xl">🤝</span>
            <p className="text-xs mt-1 text-gray-300">Social</p>
      ...
      <div className="bg-white rounded-2xl p-6 shadow-sm mb-8">
        <h4 className="text-center font-bold text-rayo-azul-oscuro mb-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <a
            ...
            className="flex items-center justify-center gap-2 py-3 bg-rayo-azul-oscuro text-rayo-amarillo
                       rounded-xl font-semibold hover:bg-rayo-azul-medio transition-colors"
          >
            📧 Enviar email
          </a>
        </div>
        <p className="text-center text-xs text-gray-400 mt-3">
          Respuesta en menos de 2 horas · Sin compromiso · info@rayo.ar
        </p>
      </div>

      {/* Disclaimer + nueva cotización */}
      <div className="text-center space-y-4">
        ...
        <button
          ...
          className="text-sm text-rayo-azul-medio hover:text-rayo-azul-oscuro
